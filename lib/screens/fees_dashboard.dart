...
class FeesPaymentPage extends StatelessWidget {
        ...
        child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snap) {
            ...
            for (final doc in docs) {
              final invoicePeriod =
                  (doc.data()['period'] ?? '').toString().trim();
              if (invoicePeriod == period) {
                latest = doc;
                break;
              }
            }
            ...
            return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: latest == null
                  ? null
                  : billingLatestSessionStream(
                      parentId: parentId, invoiceId: latest.id),
              builder: (context, sessionSnap) {
                ...
                final statusColor = _paymentStatusColor(paymentStatus, primary);
  ...
  Color _paymentStatusColor(BillingPaymentStatus status, Color primary) {
    switch (status.tone) {
